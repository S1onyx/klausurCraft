...
public class HomeController {
    ...
    @FXML private VBox notificationHost;
    ...
    public void initialize() {
        ...
        HomeNotifications.attachHost(notificationHost);
    ...
    void updateCounts() {
        HomeStatusService.StatusStats stats = HomeStatusService.computeStatusStats(tasks);
        ...
        countsTooltip.setText(HomeStatusService.buildStatusTooltip(stats));
        if (changed) {
            playCountsFeedback();
        }
    }
